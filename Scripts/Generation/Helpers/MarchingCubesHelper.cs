...
{    
     /// <summary>
     /// Collection of methods to create the actual mesh from a VoxelArray. Uses the enclosed MarchingCubes implementation.
     /// </summary>
     public static class MarchingCubesHelper
     {
          /// <summary>
          /// Use this methos to receive a mesh from the given VoxelArray.
          /// </summary>
          public static Mesh GetMeshFrom(VoxelArray voxels, bool drawNormals = false)
          {
               ...
               return CreateArrayMesh(verts, normals, indices, uv1, uv2, position);
          }

          /// <summary>
          /// Creates an actual mesh from the arrays generated by MarchingCubes.
          /// </summary>
          private static Mesh CreateArrayMesh(List<Vector3> verts, List<Vector3> normals, List<int> indices, List<Vector3> uv1, List<Vector3> uv2, Vector3 position)
          {
          ...
          /// <summary>
          /// Moves all vertices by half of the islands x and z extents.
          /// </summary>
